...
public class ShoppingCart {
	 ...
	 * If the item already exists in the cart for this same product:
	 * - The amount of the item must be the sum of the current amount and the amount passed as a parameter.
	 * - If the entered unit value is different from the current unit value of the item,
	 * the new unit value of the item must be the one passed as a parameter.
	 */
	...
	/**
	 * Allows removal of the item according to position.
	 * This position must be determined by the order in which the product is included in the collection,
	 * where zero represents the first item.
	 */
	 ...
	 * which must be the sum of the total values of all items that make up the cart.
	 */
